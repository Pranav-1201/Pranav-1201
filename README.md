...
<p align="center">
  ...
  <a href="https://doi.org/10.5281/zenodo.21970156"><img src="https://zenodo.org/badge/DOI/10.5281/zenodo.21970156.svg" alt="DOI"></a>
...
🔬 &nbsp;Working on **three research papers** — an SSL meta-analysis across NLP and CV, a cost-sensitive churn framework, and a surrogate-assisted GA for feature selection

🛠️ &nbsp;Currently a **Software Engineer Intern at BPCL R&D**, building a validated design console to replace an Excel + MATLAB workflow

🌱 &nbsp;Learning **Reinforcement Learning** and **Recommender Systems**, plus surrogate-assisted evolutionary algorithms

💬 &nbsp;Ask me about **cost-sensitive ML**, **model calibration**, **explainability**, or **React + FastAPI + Supabase** stacks

🤝 &nbsp;Open to collaborating on **ML/AI research** and **AI-integrated full-stack** systems

⚡ &nbsp;Ran my university's cybersecurity club as **Managing Director** — 100+ events over three years, including a statewide hackathon with IIIT Bhubaneswar (~600 participants)
...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21970156.svg)](https://doi.org/10.5281/zenodo.21970156)
